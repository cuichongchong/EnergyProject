 ...
 * 首页插座展示适配器
 * */
public class SocketAdapter extends BaseRecyclerViewAdapter<SocketEntity> {
    ...
    public SocketAdapter(Context context,List<SocketEntity> data,boolean isGate) {
    ...
    @Override
    protected void convert(BaseViewHolder holder, SocketEntity item, int position) {
        //插座名字
